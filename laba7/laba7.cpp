...
int main(){
   ...
   /* SetConsoleCP(1251);
    ...
    string src = "C:\Users\Gleb\Desktop\MPP\\ConsoleApplication6\\ConsoleApplication6";
    string dst = "C:\Users\Gleb\Desktop\\MPP\\ConsoleApplication6\\ConsoleApplication6-copy";
